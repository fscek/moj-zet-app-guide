# **VAŽNO**  
Ova datoteka je stvorena **strojnim prevođenjem** izvornog README-a na engleskom jeziku. Za potpunu točnost i kontekst, molimo provjerite [izvorni README na engleskom](README.md).\
Oba dokumenta će biti sadržajno usklađeni.

---

# Moj ZET mobilna aplikacija – QR i NFC „Kupnja unaprijed“
...
- [Moj ZET mobilna aplikacija – QR i NFC „Kupnja unaprijed“](#moj-zet-mobilna-aplikacija--qr-i-nfc-kupnja-unaprijed)
  ...
  - [Primjerni dokumenti](#primjerni-dokumenti)
  ...
  - [Počasni spomeni](#počasni-spomeni)
    - [ZetLoc](#zetloc)
    - [ZET info](#zet-info)
...
*Izvor: Grad Zagreb putem [www.zagreb.hr](https://www.zagreb.hr)*
...
- NFC čip, iako pomalo skriven na prednjoj strani naljepnice, može se jasno vidjeti ako se promatra s unutarnje strane.
...
2. **`ntag213-dump-sample.bin`** – *primjer* NFC NDEF zapisa s tekstom `T9999`, uz dodatne metapodatke.  
...
- **iPhone vs. Android**:  
  - Moderni iPhone uređaji (iOS 13+) obično mogu pisati na NTAG213 putem specifičnih aplikacija i čitati ih u pozadini.  
...
Kao svakodnevni korisnik, pratim ponašanje aplikacije i ažurirat ću ovaj vodič prema potrebi. Ako primijetite da aplikacija počinje tražiti usklađenost garažnog broja s vozilom, otvorite [issue](../../issues).
